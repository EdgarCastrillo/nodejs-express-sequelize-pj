...
--
-- Host: localhost:8889
-- Generation Time: Sep 11, 2019 at 05:46 PM
...
(2, 'Edgar', 'edgar@ed.com', 'hola que tal'),
(3, 'Claudia', 'clau@clau.com', 'Cras convallis enim non nunc suscipit, nec luctus ante imperdiet. Nulla facilisi. Donec aliquam, orci feugiat venenatis faucibus, mi felis placerat velit, id dictum urna elit eget nisl. Aliquam erat volutpat. Aliquam efficitur accumsan egestas. Vestibulum pulvinar et lorem id congue. Vestibulum et purus nisl.'),
(4, 'edgar', 'ed@ed.com', 'Cras convallis enim non nunc suscipit, nec luctus ante imperdiet. Nulla facilisi.'),
(5, 'Edgar', 'hola@g.com', 'wertyukjhgfdsdfgghm'),
(6, 'wswww', 'sdd@ss.co', 'xcv');
